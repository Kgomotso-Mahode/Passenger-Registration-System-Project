...
CREATE TABLE `passenger_details` (
  `FName` varchar(15) NOT NULL COMMENT 'passenger first name',
  `LName` varchar(15) NOT NULL COMMENT 'pasenger last name',
  `Dest` varchar(25) NOT NULL COMMENT 'passenger destination',
  `Phone` varchar(10) NOT NULL COMMENT 'passenger phone number'
...
-- Dump completed on 2024-10-12 14:30:23
